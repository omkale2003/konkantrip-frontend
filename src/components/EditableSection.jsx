                ...
                {tableName && primaryKeyField && (
                    <button
                        ...
                        className={`px-4 py-2 text-xs font-bold uppercase tracking-widest rounded-lg transition-colors border ${isEditing
                                ...
                                : 'text-[#226a5b] border-[#226a5b] hover:bg-[#e7f5f2] bg-white'
                            }`}
                    >
            ...
            <div className="p-6">
                                ...
                                {isEditing && !isReadonly ? (
                                    typeof value === 'boolean' || value === 1 || value === 0 ? (
                                        <select
                                            ...
                                            className="w-full text-sm border-slate-300 rounded-lg p-2.5 focus:border-[#226a5b] focus:ring focus:ring-[#226a5b] focus:ring-opacity-20 shadow-sm"
                                        >
                                        ...
                                        <textarea
                                            ...
                                            className="w-full text-sm border-slate-300 rounded-lg p-2.5 focus:border-[#226a5b] focus:ring focus:ring-[#226a5b] focus:ring-opacity-20 shadow-sm h-24 whitespace-pre-wrap"
                                        />
                                    ) : (
                                        <input
                                            type="text"
                ...
                {isEditing && (
                    <div className="mt-8 flex justify-end gap-3 pt-6 border-t border-slate-100">
                        ...
                        <button onClick={handleSave} disabled={isSaving} className="px-5 py-2.5 text-sm font-semibold text-white bg-[#226a5b] hover:bg-[#1a5548] rounded-lg transition-colors flex items-center shadow-sm disabled:opacity-50">
