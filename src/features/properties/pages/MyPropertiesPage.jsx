...
import { useProperties, useDeleteProperty } from "../hooks/useProperties.js";
                              ...
                              {activeMenuId === property.property_id && (
                                <div className="absolute right-0 top-9 z-20 w-44 rounded-xl border border-slate-200 bg-white p-1 shadow-lg text-left">
                                  ...
                                  <button
                                    ...
                                    className="flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50"
                                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl space-y-4">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Are you sure you want to delete <span className="font-bold text-slate-900">{propertyToDelete.property_name}</span>? This action cannot be undone.
            </p>
